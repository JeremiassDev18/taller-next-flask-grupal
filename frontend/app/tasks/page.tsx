...
export default async function TasksPage() {
  const tasks = [
    {
      id: 1,
      title: "Investigar Next.js",
      description: "Revisar los conceptos principales del framework.",
      status: "PENDIENTE",
    },
    {
      id: 2,
      title: "Crear backend Flask",
      description: "Implementar el Web Service REST con Python y Flask.",
      status: "EN PROCESO",
    },
    {
      id: 3,
      title: "Dockerizar proyecto",
      description: "Configurar frontend, backend y base de datos.",
      status: "PENDIENTE",
    },
  ];
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: "25px", marginBottom: "20px" }}>
          <p style={{ color: "#2563eb", fontWeight: "bold", marginBottom: "5px" }}>
          ...
          <h1 style={{ color: "#1f2937", fontSize: "34px", margin: 0 }}>
                ...
                <td style={{ padding: "14px" }}>
                  <span
                    style={{
                      ...
                      borderRadius: "20px",
                      background:
                        task.status === "EN PROCESO" ? "#dcfce7" : "#fef3c7",
                      color:
                        task.status === "EN PROCESO" ? "#166534" : "#92400e",
                      fontWeight: "bold",
                      fontSize: "13px",
                    }}
                  >
